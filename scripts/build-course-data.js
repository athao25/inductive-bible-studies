...
const META = {
  ...
  romans: {
    name: 'Romans',
    initial: 'R',
    tagline: 'The righteousness of God, from wrath to worship',
    epigraph: '"For I am not ashamed of the gospel, for it is the power of God for salvation to everyone who believes." — Romans 1:16',
    detail: 'lessons · verse-by-verse · all 16 chapters',
    status: 'complete'
  },
  trinity: {
    name: 'The Trinity',
...
const out = {};
['john', 'matthew', 'isaiah', 'romans', 'trinity'].forEach((k) => { out[k] = build(k); });
